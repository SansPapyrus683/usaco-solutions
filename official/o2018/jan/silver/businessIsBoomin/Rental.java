...
public class Rental {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader read = new BufferedReader(new FileReader(new File("rental.in")));
    ...
    /**
     * not meant to be used for anything general
     * this is why i hate usaco
     * @return just a hashmap with some like this much milk -> this much money (not every amt of milk is given)
     */
    static HashMap<Long, Long> calcMilkIncome() {
        ...
        for (int i = cows.length - 1; i >= 0; i--) {  // calculate the prices we're going to need
            ...
            do {
                if (c <= milkLeft) {
                    ...
                    currMoney += milkLeft * stores[storePointer][1];
